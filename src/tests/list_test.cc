...
TEST(List, Constructor_Copy) {
  s21::list<int> s21_list_1 = {'a', 'b', 'c', 'd'};
  std::list<int> std_list_1 = {'a', 'b', 'c', 'd'};
...
TEST(List, Modifier_Swap) {
  s21::list<int> s21_list_1 = {'a', 'p', 'p', 'l', 'e'};
  s21::list<int> s21_list_2 = {'g', 'l', 'o', 'o', 'm', 'k', 'i'};
  s21::list<int> s21_list_3 = {'a', 'p', 'p', 'l', 'e'};
  s21::list<int> s21_list_4 = {'g', 'l', 'o', 'o', 'm', 'k', 'i'};
...
TEST(List, Modifier_Splice) {
  ...
  std::list<int> list2_std = {10, 20, 30, 40, 50};
  auto it_std = list_std.begin();
  ++it_std;
  list_std.splice(it_std, list2_std);

  auto it1 = list.begin();
  auto it2 = list_std.begin();
...
TEST(List, Insert_many) {
  ...
  auto it = list.cbegin();
  ++it;
  list.insert_many(it, 65, 67, 87, 45, 67, 27, 9);
  std::list<int> result = {1, 9, 27, 67, 45, 87, 67, 65, 2, 3};
...
TEST(List, Insert_many_back) {
  s21::list<int> cl{11, 11, 11, 22, 22, 22};
...
TEST(List, Insert_many_front) {
  s21::list<int> list = {1, 2, 3};
  list.insert_many_front(65, 67, 87, 45, 67, 27, 9);
  std::list<int> result = {9, 27, 67, 45, 87, 67, 65, 1, 2, 3};
